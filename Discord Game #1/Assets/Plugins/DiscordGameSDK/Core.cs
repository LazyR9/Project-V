...
namespace Discord
{
    ...
    public partial class OverlayManager
    {
        ...
        internal partial struct FFIMethods
        {
            ...
            // For some reason the following line had "bool" where "Result" is now. If this doesn't work, change the code back.
            [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
            internal delegate Result IsPointInsideClickZoneMethod(IntPtr methodsPtr, Int32 x, Int32 y);
